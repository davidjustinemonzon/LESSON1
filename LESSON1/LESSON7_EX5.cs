...
namespace LESSON1
{
    public partial class LESSON7_EX5 : Form
    {
        ...
        private void LESSON7_EX5_Load(object sender, EventArgs e)
        {
        ...
        private void others_loanCombo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                other_loantxtBox.Text = "500.00";
            }
            else if (others_loanCombo.Text == "Other 2")
            {
                other_loantxtBox.Text = "550.00";
            }
            else if (others_loanCombo.Text == "Other 3")
            {
                other_loantxtBox.Text = "1550.00";
            }
            else if (others_loanCombo.Text == "Other 4")
            {
                other_loantxtBox.Text = "1250.00";
            }
        }
    }
}
